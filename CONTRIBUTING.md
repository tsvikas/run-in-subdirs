# Contributing to run-in-subdirs
...
Found a bug or have a feature request? [Open an issue](https://github.com/tsvikas/run-in-subdirs/issues/new) on GitHub.

### 💬 Join Discussions

Have questions or ideas? Join the conversation in [GitHub Discussions](https://github.com/tsvikas/run-in-subdirs/discussions).
...
1. Clone this repository:
   ...
   ```bash
   git clone https://github.com/tsvikas/run-in-subdirs.git
   ```
